                        ...
                        <form class="add_cat_form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                  ...
                                  <input type="text" class="form-control" name="cat_name" id="cat_name" value="<?=$_GET['name']?>">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <button type="submit" name="btn-edit_cat" class="btn btn-success" value="true">Внести изменения</button>
                                    <button type="submit" name="btn-delete_cat" class="btn btn-danger" value="true">Удалить категорию</button>
                                </div>
                            </div>
                        </form>
                    </div>
